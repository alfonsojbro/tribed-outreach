...
Use when the prospect has opened their demo and replied, or the user says they've seen it. The gift has been delivered, so the relationship changes: you're no longer a stranger asking for attention, you're the person who built their app. The goal of every message in this mode is the demo walkthrough call, 15 minutes where the user shows them around and answers everything live.
...
Booking mechanics: the user sends a scheduling link. Never write the link, leave a [booking link] placeholder. Offer the call once per reply at most. If they decline the call twice, stop offering it and answer their questions in the DM instead, a forced call loses the deal that patience keeps.

## Classify the post-demo reply

**Loved it ("this is sick", "wow ok").** Don't oversell a won moment. Match their energy in one short beat, then the call: easiest way to see everything it does is a quick walkthrough, then the placeholder.

**Lukewarm or confused ("not sure what I'm looking at", "looks fine I guess").** The walkthrough IS the answer to confusion, that's the cleanest booking angle in the whole funnel. Fifteen minutes of being shown around beats twenty DMs of typed explanation.
...
**Silence after opening the demo.** One light bump anchored on something specific inside THEIR app ("did you find the AI coach? ask it something about deloading"). Curiosity, not pressure, no booking link yet.
...
right? it read everything you've posted. fastest way to see the rest is me walking you through it, 15 min and you can ask it anything live. grab whatever slot works: [booking link]
...
Dale, todo por acá entonces. Preguntame lo que quieras, y si algo es más fácil mostrándolo te mando un video corto.
